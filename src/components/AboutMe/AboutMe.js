                ...
                <article className="about-me__article">
                    <div className="about-me__article-content">
                        ...
                        <p className="about-me__article-text">
                            Я родилась и живу в Санкт-Петербурге. Закончила
                            факультет математики и информатики РГПУ им.
                            А.И.Герцена. 14 лет прожила на Дальнем Востоке. У
                            меня две дочери и сын. Люблю кататься на сноуборде,
                            заниматься дайвингом, ходить в спортзал. Работаю
                            контент-менеджером в семейной фирме. Пошла курс по
                            веб-разработке. Планирую развиваться в данном
                            направлении.
                        </p>
                        <ul className="about-me__article-links">
                            <li className="about-me__article-link">
                                <a
                                    ...
                                    href="https://vk.com/ekaterinamanuylova"
                                    target="_blank"
                                    rel="noreferrer"
                                >
                                    ВКОНТАКТЕ
                            ...
                            <li className="about-me__article-link">
                                <a
                                    ...
                                    href="https://github.com/EkaterinaManuilova"
                                    target="_blank"
                                    rel="noreferrer"
                                >
                                    Github
